  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center px-6 font-sans">
      <div className="max-w-md w-full text-center">
        ...
        <h2 className="text-3xl font-bold text-slate-900 mb-4 dark:text-slate-100">Page not found</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            onClick={handleBack}
            className="flex items-center justify-center px-6 py-3 border border-slate-300 dark:border-gray-600 text-slate-700 dark:text-gray-200 font-semibold rounded-xl hover:bg-slate-100 dark:hover:bg-gray-700 transition-colors"
          >
