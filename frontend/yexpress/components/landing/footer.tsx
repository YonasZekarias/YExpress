      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold text-slate-900">YExpress</span>
            </div>
        ...
        <div className="border-t border-slate-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <div className="w-5 h-5 bg-slate-300 rounded-full hover:bg-indigo-600 transition cursor-pointer"><Facebook/></div>
            <div className="w-5 h-5 bg-slate-300 rounded-full hover:bg-indigo-600 transition cursor-pointer"><Twitter/></div>
            <div className="w-5 h-5 bg-slate-300 rounded-full hover:bg-indigo-600 transition cursor-pointer"><Instagram/></div>
          </div>
        </div>
      </div>
    </footer>
